const AI_SYSTEM_PROMPT = `You are an expert cinematographer and prompt engineer for AI image and video generation.
...
function extractScenePlan(response) {
  try {
...
export { AI_SYSTEM_PROMPT as A, buildContextString as b, extractScenePlan as e };
